...
// Implements the server side that receives client's calls and replies with result.
...
public:
	...
	// This method is used to deliver events to the client, so the server does not expect reply.
